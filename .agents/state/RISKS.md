...
|----|--------|------------|
| R-002 | Scope MVP trop large | Vertical slices, gates entre sous-phases |
| R-003 | Contenu réel insuffisant | Préparer avant mise en ligne |
| R-004 | Design générique | Gates UX/UI premium |
| R-006 | Spam contact | ADR-0006, rate limiting |
| R-007 | Sécurité admin | ADR-0003, ADR-0011, audits Security |
